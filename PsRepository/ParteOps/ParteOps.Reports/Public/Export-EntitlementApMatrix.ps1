function Export-EntitlementAccessPackageReport {
    [CmdletBinding()]
    param(
        [string[]] $CatalogId,
        [string[]] $PackageId,
    ...
    $collectionResources = Get-EntitlementCatalogResources -CatalogId $CatalogId | Where-Object { $_.OriginSystem -eq "AadGroup" }
    $packages = Get-EntitlementAccessPackageResources -CatalogId $CatalogId -PackageId $PackageId | Where-Object { $_.OriginSystem -eq "AadGroup" }
